        ...
        <Card>
          <CardContent className="pt-6">
            ...
            <p className="text-2xl font-bold">
              Rs. {payments.filter((p) => p.status === 'paid').reduce((sum, p) => sum + p.amount, 0).toLocaleString()}
            </p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="pt-6">
            ...
            <p className="text-2xl font-bold">
              Rs. {payments.filter((p) => p.status === 'pending').reduce((sum, p) => sum + p.amount, 0).toLocaleString()}
            </p>
          </CardContent>
        </Card>
        <Card>
